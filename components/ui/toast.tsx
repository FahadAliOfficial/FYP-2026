  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        variant === "destructive" &&
          "destructive group border-red-500 bg-red-600 text-slate-50 dark:border-red-900 dark:bg-red-900",
        className
      )}
      {...props}
    />
